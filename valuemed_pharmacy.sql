...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2026 at 05:19 AM
...
(14, 'Acetylcysteine', '200mg', 'Tablet', 0.00, 0.00, 15, '2028-10-26'),
(15, 'Acetylcysteine', '600mg', 'Tablet', 50.00, 0.00, 14, '2028-11-26'),
(16, 'Aciclovir', '200mg', 'Tablet', 50.00, 0.00, 176, '2028-10-26'),
...
(21, 'Ambroxol', '30mg', 'Tablet', 0.00, 0.00, 198, NULL),
(22, 'Amlodipine', '5mg', 'Tablet', 0.00, 0.00, 24, NULL),
(23, 'Amlodipine', '10mg', 'Tablet', 0.00, 0.00, 142, NULL),
(24, 'Amlo+Losartan', '5mg/50mg', 'Tablet', 0.00, 0.00, 7, NULL),
...
--
ALTER TABLE `sale_items`
  MODIFY `sale_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
