...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2026 at 04:45 PM
...
(2, 'Biogesic', 'Paracetamol-based medicine for fever and pain', 'Tablet', 8.00, 4.00, 23, '2027-12-31'),
(3, 'Amoxicillin', 'Antibiotic used to treat bacterial infections', 'Capsule', 12.00, 7.00, 1, '2027-08-31'),
...
(7, 'Omeprazole', 'Used to reduce stomach acid', 'Capsule', 15.00, 8.00, 45, '2028-01-31'),
...
(55, 55, '2026-09-25', 36.00, 3),
(56, 56, '2026-09-25', 36.80, 4);
...
(113, 55, 3, 3, 12.00, 36.00),
(114, 56, 2, 2, 8.00, 16.00),
(115, 56, 7, 2, 15.00, 30.00);
...
--
ALTER TABLE `sale_items`
  MODIFY `sale_item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
